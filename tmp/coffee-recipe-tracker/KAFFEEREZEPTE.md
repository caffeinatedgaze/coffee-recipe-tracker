...
### 2026-08-27 - The Barn - Guava Banana Origami Base Recipe

- Source: Telegram topic `Kaffeerezepte` / image
- Timestamp: 2026-08-27 10:33 local
- Type: recipe
...
- Timing: 0:35 bloom; then pour to 120 g and 180 g; total drawdown 2:15-2:45
- Stirring: none; one gentle swirl after the bloom only
- Tasting notes: guava; mango; vibrant; package label notes from the bag photo
- Outcome: first-pass Origami baseline for this bag, tuned to keep the fruit clean and the cup bright without getting thin
- Next adjustment: brew this version first; if it reads too sharp, go 1 click coarser next time and keep everything else the same
- Highlight: no
- Related entries: none
...
- Tasting notes: unknown
- Outcome: corrected the bean name and saved the current working baseline for this decaf bag
...
- Stirring: unknown
- Tasting notes: clean and nice
- Outcome: lowered temperature to calm the bitterness and keep the cup cleaner; this cup now reads clean and nice
