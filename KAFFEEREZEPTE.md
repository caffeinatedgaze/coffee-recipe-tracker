...
- Timestamp: 2026-08-02 08:21-12:00 local
- Type: recipe/result
...
- Outcome: one coffee session; smooth and stable, but the plum note still did not show; latest setup keeps volume down and uses the exact mini Aeropress recipe
